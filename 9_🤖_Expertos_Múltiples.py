...
APP_IDENTITY = {
    ...
    "docs_url": "https://github.com/bladealex9848/TutelaBot/blob/main/README.md",
    ...
    "long_description": """
    ### 🧑‍⚖️📝 ¡Hola! Soy TutelaBot, tu asistente especializado en Acción de Tutela y Derecho de Petición en Colombia

    Estoy aquí para brindarte información y apoyo en estos dos mecanismos constitucionales fundamentales para la protección de tus derechos según la Constitución Política de 1991, el Decreto 2591 de 1991 y la Ley 1755 de 2015.

    #### ¿Qué puedo hacer por ti hoy? 🤔

    * Explicarte qué son la Acción de Tutela y el Derecho de Petición
    * Informarte sobre los requisitos y procedimientos para presentarlos
    * Ayudarte a identificar cuándo proceden estos mecanismos
    * Guiarte en la redacción de documentos con ejemplos prácticos
    * Orientarte sobre plazos, términos y autoridades competentes
    * Aclararte el trámite de impugnación y revisión de tutelas
    * Explicarte cómo responder adecuadamente a estos mecanismos

    **¡No dudes en consultarme cualquier inquietud sobre estos importantes mecanismos constitucionales!**

    *Recuerda: Proporciono información general basada en mi conocimiento actual, que incluye la Constitución Política, el Decreto 2591 de 1991 y la Ley 1755 de 2015. Para asesoría legal específica para tu caso, consulta a un abogado.*
    """,
    # User instructions
    "usage_instructions": """
    1. **Consultas generales**: Escribe tu pregunta en el chat para recibir información sobre la Acción de Tutela o el Derecho de Petición en Colombia.

    2. **Análisis de casos**: Describe tu situación para que pueda orientarte sobre el mecanismo más adecuado y los pasos a seguir.

    3. **Solicitud de formatos**: Pídeme modelos o ejemplos para redactar una tutela o un derecho de petición según tu necesidad específica.

    4. **Revisión de borradores**: Comparte tu borrador para que pueda darte sugerencias de mejora.

    5. **Información procedimental**: Consulta sobre trámites, plazos, autoridades competentes o cualquier aspecto práctico de estos mecanismos.
    """,
    # Document processing information
    "document_processing_info": """
    Esta aplicación utiliza tecnología de procesamiento de texto para:

    - Analizar documentos legales como tutelas, derechos de petición o respuestas
    - Extraer información relevante para entender su contenido y estructura
    - Identificar deficiencias o áreas de mejora en documentos legales
    ...
    **Formatos soportados**: PDF (.pdf), Texto (.txt), Imágenes (.jpg, .jpeg, .png). Otros formatos no serán procesados.
    ...
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, analiza su contenido desde la perspectiva de la Acción de Tutela o el Derecho de Petición en Colombia.",
    "badges": """
    ![Visitantes](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Ftutelabot.streamlit.app&label=Visitantes&labelColor=%235d5d5d&countColor=%231e7ebf&style=flat)
    """,
    # Welcome message (displayed on first load)
    "welcome_message": """
    ### 🧑‍⚖️📝 ¡Bienvenido a TutelaBot!

    Soy tu asistente especializado en la Acción de Tutela y el Derecho de Petición en Colombia. Estoy aquí para ayudarte a comprender y utilizar estos importantes mecanismos constitucionales basados en la Constitución Política de 1991, el Decreto 2591 de 1991 y la Ley 1755 de 2015.

    * Puedo responder preguntas sobre el marco normativo y la naturaleza jurídica de estos mecanismos
    * Proporcionarte guía paso a paso sobre cómo presentarlos correctamente
    * Ayudarte a identificar cuándo son procedentes y cuándo no
    * Ofrecerte modelos y ejemplos prácticos para redactar tus documentos
    * Orientarte sobre términos, plazos y autoridades competentes
    ...
    **¿En qué puedo ayudarte hoy?**
    ...
    "menu_items": {
        ...
        "Report a bug": None,
        "About": "TutelaBot: Asistente especializado en Acción de Tutela y Derecho de Petición basado en la Constitución Política de 1991, el Decreto 2591 de 1991 y la Ley 1755 de 2015",
    },
    # Footer text
    "footer_text": """
    {developer}
...
with st.sidebar:
    ...
    if st.button("Nueva Conversación", use_container_width=True):
        ...
        if "client" in st.session_state and st.session_state.client:
            ...
            # Registrar el experto actual en el historial
...
def load_assistants_config():
    ...
    try:
        ...
        st.error("No se pudo cargar la configuración de asistentes. Verifique el archivo secrets.toml")
        return {}
...
if "current_expert" not in st.session_state:
    # Establecer un experto predeterminado (tutela)
    default_expert = "tutela"
    st.session_state.current_expert = default_expert
    # Registrar el primer experto en el historial
    st.session_state.expert_history.append({
        "timestamp": datetime.now().strftime("%H:%M:%S"),
